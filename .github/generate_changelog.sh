...
# Usage: ./generate_changelog.sh [<git-log-range>] [<docker-image>] [<package-url>]
#
...
#
# If <docker-image> is given, a linked "Docker image" section with a pull
# command is printed above the changelog.
